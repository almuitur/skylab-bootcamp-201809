...
app.delete('/api/user/:id/postits/:postitId', (req, res) => {
...
app.put('/api/user/:id/postits/:postitId', jsonBodyParser, (req, res) => {
    const { params: { id, postitId }, headers: { authorization }, body: { text } } = req
