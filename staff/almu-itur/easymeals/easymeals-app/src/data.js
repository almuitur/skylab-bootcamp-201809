        ...
        switch (plan) {
            case 'balanced':
                ...
                let tuesday = [
                    ...
                    { day: 'tuesday', mealTime: 'dinner', search: { category: 'soup', subcategory: 'none', season: season, isCold: false, isSpecialMeal: false } },
                ...
                let thursday = [
                    ...
                    { day: 'thursday', mealTime: 'dinner', search: { category: 'soup', subcategory: 'none', season: season, isCold: false, isSpecialMeal: false } },
                ...
                let saturday = [
                    ...
                    { day: 'saturday', mealTime: 'lunch', search: { category: 'carb', subcategory: 'none', isSpecialMeal: true } },
                ...
                switch (diet) {
                    case 'vegan':
                        monday[7].search.subcategory = 'none'
                        tuesday[7].search.subcategory = 'none'
                        wednesday[7].search.subcategory = 'none'
                        thursday[7].search.subcategory = 'none'
                        saturday[4].search.subcategory = 'none'
            ...
            case 'diet':
                ...
                tuesday = [
                    ...
                    { day: 'tuesday', mealTime: 'dinner', search: { category: 'soup', subcategory : 'none', season: season, isCold: false, isSpecialMeal: false, isLight: true } },
                ...
                thursday = [
                    ...
                    { day: 'thursday', mealTime: 'dinner', search: { category: 'soup', subcategory : 'none', season: season, isCold: false, isSpecialMeal: false, isLight: true } },
                ...
                saturday = [
                    ...
                    { day: 'saturday', mealTime: 'lunch', search: { category: 'vegetable', subcategory : 'none', isSpecialMeal: true, isLight: true } },
                ...
                sunday = [
                    ...
                    { day: 'sunday', mealTime: 'lunch', search: { category: 'protein', subcategory : 'none', isSpecialMeal: true, isLight: true } },
